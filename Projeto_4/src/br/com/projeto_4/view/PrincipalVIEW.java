...
public class PrincipalVIEW extends javax.swing.JFrame {
     ...
     */
    public PrincipalVIEW(FuncionarioDTO dto) {
        initComponents();
        //Colocando o Icone do Formulário
        setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("imagens/salvar.png")));

        this.setLocationRelativeTo(null);

        if (dto.getTipo_fun().equalsIgnoreCase("COMUM")) {
